...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-ObservationDiaryUITests/Material.framework"
  install_framework "Pods-ObservationDiaryUITests/MobilePlayer.framework"
  install_framework "Pods-ObservationDiaryUITests/Rswift.framework"
  ...
  install_framework "Pods-ObservationDiaryUITests/SwiftyJSON.framework"
